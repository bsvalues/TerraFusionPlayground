...
export function createMarketRoutes(storage: IStorage, llmService: LLMService) {
   ...
   */
  router.get(
    '/economic-indicators/property/:propertyId',
    asyncHandler(async (req, res) => {
      const propertyId = req.params.propertyId;
  ...
  router.get(
    ...
    asyncHandler(async (req, res) => {
      ...
      const enhancedPrediction = {
        ...
        methodology:
          'Combined statistical analysis with AI-augmented predictive modeling and comparable property analysis',
