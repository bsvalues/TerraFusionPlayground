...
export interface IStorageWithWebVitals extends IStorage {
  ...
  getWebVitalsAggregates(timeRange: string, metricName?: string, urlPattern?: string): Promise<any[]>;
...
export function extendStorageWithWebVitals(storage: any): IStorageWithWebVitals {
  ...
  storage.getWebVitalsMetrics = async function(timeRange: string, metricName?: string, limit: number = 100): Promise<any[]> {
  ...
  storage.getWebVitalsAggregates = async function(timeRange: string, metricName?: string, urlPattern?: string): Promise<any[]> {
  ...
  storage.getWebVitalsAlerts = async function(timeRange: string, acknowledged?: boolean): Promise<any[]> {
