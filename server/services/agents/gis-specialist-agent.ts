...
export class GISSpecialistAgent extends BaseAgent {
  ...
  private async handleSpatialAnalysisRequest(message: any): Promise<any> {
    try {
      ...
      await this.logActivity('error', `Spatial analysis error: ${error.message}`, { error: error.message });
  ...
  private async handleMapStylingRequest(message: any): Promise<any> {
    try {
      ...
      await this.logActivity('error', `Map styling error: ${error.message}`, { error: error.message });
  ...
  private async generateMapStyling(request: MapStylingRequest): Promise<any> {
    ...
    switch (request.purpose) {
      case 'thematic':
        colorScheme = request.dataType === 'categorical' 
  ...
  private async handleFeatureDetectionRequest(message: any): Promise<any> {
    try {
      ...
      await this.logActivity('error', `Feature detection error: ${error.message}`, { error: error.message });
  ...
  private async handleAreaAnalysisRequest(message: any): Promise<any> {
    try {
      ...
      await this.logActivity('error', `Area analysis error: ${error.message}`, { error: error.message });
