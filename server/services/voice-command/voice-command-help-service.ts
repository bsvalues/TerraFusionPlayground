...
export class VoiceCommandHelpService {
  ...
  async createHelpContent(helpData: InsertVoiceCommandHelpContent): Promise<any> {
    try {
      const [result] = await db.insert(voiceCommandHelpContents).values(helpData).returning();
  ...
  async updateHelpContent(
    helpId: number,
    helpData: Partial<InsertVoiceCommandHelpContent>
  ): Promise<any> {
    try {
      const [result] = await db
        .update(voiceCommandHelpContents)
        .set({
          ...helpData,
          updatedAt: new Date(),
        })
  ...
  async deleteHelpContent(helpId: number): Promise<boolean> {
    try {
      await db.delete(voiceCommandHelpContents).where(eq(voiceCommandHelpContents.id, helpId));
   ...
   */
  async getHelpContentByCommandType(
    ...
    try {
      ...
      const defaultHelpContent: InsertVoiceCommandHelpContent[] = [
        // Navigation commands
        {
          ...
          description:
            'Navigation commands allow you to move between different pages and sections of the application without clicking.',
          parameters: {
        ...
        // Property assessment commands
        {
          ...
          description:
            'Property assessment commands help you work with property valuations, comparables, and reports.',
          parameters: {
        ...
        // Data query commands
        {
          ...
          description:
            'Data query commands let you search and filter property data using natural language.',
          parameters: {
        ...
        // Workflow commands
        {
          ...
          description:
            'Workflow commands help you manage assessment workflows, tasks, and team collaboration.',
          parameters: {
        ...
        // System commands
        {
          ...
          description:
            'System commands control the voice interface itself and provide help with available commands.',
          parameters: {
        ...
        // Context-specific help: Property Details page
        {
          ...
          description:
            'These commands are specific to the property details page and help you work with the current property.',
          parameters: {
        ...
        // Context-specific help: Dashboard
        {
          ...
          description:
            'These commands help you interact with the dashboard and analyze assessment data.',
          parameters: {
