    ...
    .action(async (options) => {
      ...
      if (options.testRecording) {
        ...
        try {
          ...
          console.log(chalk.red('Your system may not have the necessary audio libraries installed.'));
        }
      ...
      if (options.realRecording) {
        ...
        console.log(chalk.yellow('If you encounter issues, try running: codeagent voice --test-recording'));
      } else {
