...
export class ToolRegistry {
  ...
  private executionHistory: Array<{ tool: string, args: any, result: ToolResult, timestamp: Date }> = [];
   ...
   */
  getExecutionHistory(limit?: number): Array<{ tool: string, args: any, result: ToolResult, timestamp: Date }> {
   ...
   */
  getToolExecutionHistory(toolName: string, limit?: number): Array<{ args: any, result: ToolResult, timestamp: Date }> {
