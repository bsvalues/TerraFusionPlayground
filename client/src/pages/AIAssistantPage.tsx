      ...
      <Tabs defaultValue="perplexity" className="space-y-4">
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="h-[400px] flex items-center justify-center text-muted-foreground">
                OpenAI integration already available - Switch to the Perplexity tab to try the new
                integration
              </div>
            </CardContent>
          </Card>
        ...
        <TabsContent value="anthropic" className="space-y-4">
          <Card>
            <CardContent className="pt-6">
              <div className="h-[400px] flex items-center justify-center text-muted-foreground">
                Anthropic Claude integration already available - Switch to the Perplexity tab to try
                the new integration
              </div>
            </CardContent>
          </Card>
