        ...
        <TabsContent value="minimalist" className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div 
                key={idx} 
                className="tf-card p-6 hover:shadow-lg transition-all duration-300"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <ThreeDCard className="p-6 border border-border/30">
              <div className="flex flex-col h-full">
                ...
                <p className="tf-font-body text-sm mb-4">Explore property terrain with immersive 3D visualization. Hover over this card to experience the 3D effect.</p>
            ...
            <ThreeDCard className="p-6 border border-border/30" depth={20} glowColor="rgba(147, 51, 234, 0.5)">
              <div className="flex flex-col h-full">
                <div className="mb-4">
                ...
                <p className="tf-font-body text-sm mb-4">View multiple data layers with enhanced interactive controls. This card has a deeper 3D effect.</p>
                <div className="mt-auto">
                  <Button variant="outline" className="w-full">View Layers</Button>
                </div>
              </div>
            </ThreeDCard>
            ...
            <ThreeDCard className="p-6 border border-border/30" depth={10} glare={false}>
              <div className="flex flex-col h-full">
                ...
                <p className="tf-font-body text-sm mb-4">Access property location information with subtle 3D effects. This card has no glare effect.</p>
                <div className="mt-auto">
                  <Button variant="secondary" className="w-full">View Location</Button>
                </div>
              </div>
            </ThreeDCard>
          </div>
        ...
        <TabsContent value="interactive" className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="tf-card p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Button variant="secondary" className="tf-button-secondary w-full">Hover for Elevation</Button>
                </div>
                <div>
                  <h4 className="text-sm font-medium mb-2">Outline Button</h4>
                  <Button variant="outline" className="tf-button-outline w-full">Interactive Border</Button>
                </div>
              </div>
            </div>
            ...
            <div className="tf-card p-6">
              ...
              <div className="space-y-4">
                <div 
                  className="tf-card p-4 flex items-center hover:shadow-lg cursor-pointer transition-all duration-300 transform hover:-translate-y-1"
                >
                ...
                <div
                  className="tf-card-gradient p-4 flex items-center hover:shadow-lg cursor-pointer transition-all duration-300"
                >
                ...
                <div
                  className="tf-card-glass p-4 flex items-center hover:shadow-xl cursor-pointer transition-all duration-300 backdrop-blur-lg"
                >
                  <div className="mr-4 p-2 rounded-full bg-white/20 text-white">
            ...
            <div className="tf-card p-6">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="tf-font-body">The modern design system emphasizes readability and visual hierarchy. This body text uses optimal line height and spacing for comfortable reading.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <TabsContent value="textures" className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              <p className="tf-font-body text-sm mb-4">This card uses a subtle noise texture to add depth and dimension to the flat surface. Hover to see the elevation effect.</p>
              <Button variant="default" className="w-full">Blue Variant</Button>
            </TexturedCard>
            ...
            >
              ...
              <p className="tf-font-body text-sm mb-4">A medium noise texture creates more visual interest and tactile feel. This card has a floating elevation style.</p>
              <Button variant="default" className="w-full bg-purple-600 hover:bg-purple-700">Purple Variant</Button>
            </TexturedCard>
            ...
            >
              ...
              <p className="tf-font-body text-sm mb-4">Pronounced texture adds significant depth and a tactile quality to the interface. This uses a mixed color gradient.</p>
              <Button variant="default" className="w-full bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600">Gradient Variant</Button>
            </TexturedCard>
          </div>
              ...
              <div className="flex flex-col md:flex-row gap-6">
                <div className="flex-1">
                  ...
                  <p className="tf-font-body mb-4">
                    In 2025, noise and textures are gaining traction in web design, adding depth and realism to digital interfaces. 
                    Grainy effects introduce dimensionality, making flat designs feel more tangible and engaging.
                  </p>
                  <p className="tf-font-body mb-4">
                    Incorporating subtle textures and noise creates a more immersive experience, drawing users into the content while 
                    moving away from overly polished, sterile designs.
                  </p>
                ...
                <div className="flex-1 grid grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={idx} className="bg-white/10 backdrop-blur-sm rounded-lg p-4 flex flex-col items-center text-center">
