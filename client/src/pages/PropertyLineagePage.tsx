              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="space-y-1">
                    <p>
                      <span className="font-medium">Status:</span> {property?.status || 'N/A'}
                    </p>
                    <p>
                      <span className="font-medium">Value:</span>{' '}
                      {property?.value ? `$${property.value}` : 'N/A'}
                    </p>
                    <p>
                      <span className="font-medium">Acres:</span> {property?.acres || 'N/A'}
                    </p>
                  </div>
                </div>
                <div>
                  ...
                  <div className="space-y-1">
                    ...
                    <p>
                      <span className="font-medium">Changes:</span> {lineageEntries.length || 0}{' '}
                      recorded
                    </p>
                  </div>
                </div>
          ...
          {activeEntry && (
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <Button variant="outline" className="w-full" onClick={() => setActiveEntry(null)}>
          ...
          {lineageQuery.isError ? (
            <Card>
              ...
              <CardContent>
                ...
                <Button className="mt-4" onClick={() => lineageQuery.refetch()}>
