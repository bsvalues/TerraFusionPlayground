      ...
      <div className="flex flex-col space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Manage and collaborate with AI team agents</p>
          </div>
          <Badge
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card className="md:col-span-1">
            <CardHeader>
              ...
              <CardDescription>Available team members and their status</CardDescription>
            </CardHeader>
            <CardContent>
              {agentsLoading ? (
                                        ...
                                        <div key={i} className="bg-muted p-2 rounded-md text-sm">
                                          <div className="flex items-center gap-2 text-xs text-muted-foreground mb-1">
                                            <span className="font-medium">
                                              {agents.find(a => a.id === comment.userId)?.name ||
                                                'Unknown'}
                                            </span>
                                            <span>
