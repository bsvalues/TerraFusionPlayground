...
const Logo = () => (
  <div className="flex items-center">
    <img src="/assets/terrafusion-icon.svg" alt="TerraFusion" className="h-8 w-8" />
...
const SidebarMenuItem = ({ href, icon, children, isActive = false }: SidebarMenuItemProps) => {
  ...
  const inactiveClasses =
    'text-primary-blue-dark hover:bg-primary-blue-light/10 hover:text-primary-blue';
  ...
  return (
    <Link href={href}>
      ...
      >
        <span className={isActive ? 'text-white' : 'text-primary-teal'}>{icon}</span>
        {children}
      </div>
    </Link>
  );
    ...
    <div className="hidden md:flex md:flex-shrink-0">
      <div className="flex flex-col w-64 border-r border-gray-200 bg-white">
        <div className="flex items-center justify-center h-16 px-4 bg-primary-blue-dark">
          <div className="flex items-center">
            <img src="/assets/terrafusion-icon.svg" alt="TerraFusion" className="h-8 w-8" />
            <span className="ml-2 text-white font-semibold text-lg tf-font-heading">
              TerraFusion
            </span>
          </div>
        </div>
        ...
        <div className="overflow-y-auto flex-grow">
          <nav className="px-2 py-4 space-y-1">
            {/* Dashboard Link */}
            <SidebarMenuItem href="/" icon={<DashboardIcon />} isActive={location === '/'}>
              Dashboard
            </SidebarMenuItem>
        ...
        <div className="flex-shrink-0 flex border-t border-gray-200 p-4">
          <div className="flex-shrink-0 w-full group block cursor-pointer">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-sm font-medium text-primary-blue-dark group-hover:text-primary-blue tf-font-body">
                  {user?.name}
                </p>
                <p className="text-xs font-medium text-primary-teal-dark group-hover:text-primary-teal tf-font-body">
                  {user?.role}
                </p>
              </div>
            </div>
