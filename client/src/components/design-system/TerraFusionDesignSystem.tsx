    ...
    <div className="p-6 bg-background-light text-primary-gray-dark max-w-7xl mx-auto">
      <header className="mb-8">
        ...
        <p className="text-lg text-primary-gray mb-4 tf-font-body">
          A comprehensive design system for building consistent, accessible, and visually appealing applications.
        </p>
      </header>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="overview" className="space-y-8">
          <Card>
            ...
            <CardContent>
              <p className="mb-4">
                The TerraFusion Design System provides a comprehensive set of guidelines, components, and resources 
                to create consistent, user-friendly interfaces across all TerraFusion applications. This system is 
                built on modern web standards and accessibility best practices.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                <div className="p-4 border border-secondary-gray rounded-md">
                  ...
                  <p className="text-primary-gray-dark">Unified design language for a cohesive user experience.</p>
                </div>
                <div className="p-4 border border-secondary-gray rounded-md">
                  <h3 className="font-semibold text-primary-blue-dark mb-2">Accessibility</h3>
                  <p className="text-primary-gray-dark">WCAG 2.1 AA compliant components and patterns.</p>
                </div>
                <div className="p-4 border border-secondary-gray rounded-md">
                  <h3 className="font-semibold text-primary-blue-dark mb-2">Flexibility</h3>
                  <p className="text-primary-gray-dark">Adaptable system that scales to different applications.</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-medium text-primary-blue-dark mb-2">1. Install dependencies</h3>
                ...
                <div>
                  <h3 className="text-lg font-medium text-primary-blue-dark mb-2">2. Import CSS variables</h3>
                  <pre className="bg-secondary-gray-ultralight p-3 rounded-md overflow-x-auto tf-font-mono">
                    <code>@import './styles/terrafusion-tokens.css';</code>
                  </pre>
                </div>
                <div>
                  <h3 className="text-lg font-medium text-primary-blue-dark mb-2">3. Update Tailwind configuration</h3>
                  <pre className="bg-secondary-gray-ultralight p-3 rounded-md overflow-x-auto tf-font-mono">
                    <code>{`import terrafusionPlugin from './scripts/patchTailwind';\n\nexport default {\n  // ...\n  plugins: [terrafusionPlugin()],\n};`}</code>
                  </pre>
                </div>
                <div>
                  <h3 className="text-lg font-medium text-primary-blue-dark mb-2">4. Use TerraFusion components</h3>
                  <pre className="bg-secondary-gray-ultralight p-3 rounded-md overflow-x-auto tf-font-mono">
        ...
        <TabsContent value="components" className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  <button className="bg-primary-blue text-white px-4 py-2 rounded-md">Primary Button</button>
                  <button className="bg-secondary-gray text-primary-gray-dark px-4 py-2 rounded-md">Secondary Button</button>
                  <button className="border border-primary-blue text-primary-blue px-4 py-2 rounded-md">Outline Button</button>
                </div>
              </CardContent>
              <CardFooter>
                <a href="#" className="text-primary-blue hover:underline">View documentation</a>
              </CardFooter>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="border border-secondary-gray rounded-md p-4">
                  ...
                  <p className="text-primary-gray text-sm mt-1">Card description or content goes here.</p>
                </div>
              </CardContent>
              <CardFooter>
                <a href="#" className="text-primary-blue hover:underline">View documentation</a>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="p-4 border border-secondary-gray rounded-md">
                  ...
                  <p className="text-primary-gray-dark mb-4">Consistent approach to form validation and error states.</p>
          ...
          <Card>
            ...
            <CardContent>
              <div className="border border-secondary-gray rounded-md p-4">
                ...
                <p className="text-primary-gray-dark mb-4">Guidelines for displaying tabular data.</p>
                    ...
                    <tbody>
                      <tr className="border-b border-secondary-gray">
                        ...
                        <td className="px-4 py-2">
                          <span className="bg-primary-green-light text-primary-green-dark px-2 py-1 rounded-full text-xs">Active</span>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td className="px-4 py-2">
                          <span className="bg-secondary-orange-light text-primary-orange-dark px-2 py-1 rounded-full text-xs">Pending</span>
                        </td>
                      </tr>
                    </tbody>
                  </table>
        ...
        <TabsContent value="guidelines" className="space-y-8">
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <p>
                  TerraFusion follows WCAG 2.1 AA guidelines to ensure our applications are accessible to as many users as possible.
                  Below are some key accessibility principles to follow:
                </p>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <p>
                  TerraFusion applications are designed to be fully responsive, providing an optimal experience across all device sizes.
                  Here are the key breakpoints to consider:
                </p>
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead className="bg-secondary-gray-light">
