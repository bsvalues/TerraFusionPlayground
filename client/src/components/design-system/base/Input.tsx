  ...
  "flex w-full rounded-md border border-input bg-background text-foreground shadow-sm transition-colors",
  {
    variants: {
      variant: {
        ...
        ghost: "border-0 bg-transparent shadow-none focus:outline-none focus:ring-1 focus:ring-primary/25",
        underlined: "rounded-none border-0 border-b border-input bg-transparent px-0 focus:outline-none focus:ring-0 focus:border-primary",
      },
      size: {
