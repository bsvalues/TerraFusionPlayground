...
import { TrendingUp, TrendingDown, Minus, Wallet, BarChart4, CircleAlert } from 'lucide-react';
      ...
      <CardHeader className="pb-2">
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <CardTitle className="text-lg font-medium">{formatIndicatorName(name)}</CardTitle>
          </div>
