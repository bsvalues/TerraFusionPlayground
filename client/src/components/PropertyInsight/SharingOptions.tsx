...
export function SharingOptions({ shareId }: SharingOptionsProps) {
  ...
  const handleDownloadPDFData = () => {
    ...
    const dataStr =
      ...
      encodeURIComponent(JSON.stringify(pdfDataMutation.data || {}, null, 2));
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Choose how you want to share this property insight</CardDescription>
      </CardHeader>
      <CardContent>
            ...
            <div className="grid w-full gap-4 py-4">
              <div className="flex flex-col space-y-1.5">
                ...
                <div className="flex space-x-2">
                  <Input id="shareableUrl" readOnly value={shareableUrl} />
            ...
            <div className="grid w-full gap-4 py-4">
              ...
              {qrCodeMutation.data && qrCodeMutation.data.qrCode && (
                <div className="mt-4 flex flex-col items-center space-y-4">
                  ...
                  <Button variant="outline" onClick={handleOpenQRCodeInNewTab}>
          ...
          <TabsContent value="pdf">
            <div className="grid w-full gap-4 py-4">
              <div className="flex flex-col space-y-1.5">
                ...
                <Input id="pdfTitle" value={pdfTitle} onChange={e => setPdfTitle(e.target.value)} />
              </div>
              ...
              {pdfDataMutation.data && (
                <div className="mt-4 space-y-4">
                  <div className="border p-4 rounded-md bg-muted overflow-auto max-h-60">
                    <pre className="text-xs">{JSON.stringify(pdfDataMutation.data, null, 2)}</pre>
                  </div>
                  <Button variant="outline" onClick={handleDownloadPDFData} className="w-full">
                    <FileDown className="mr-2 h-4 w-4" />
                    Download PDF Data
                  </Button>
                </div>
