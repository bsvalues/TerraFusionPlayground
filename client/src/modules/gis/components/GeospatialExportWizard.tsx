  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <Button variant="outline" className="w-full flex justify-start items-center" onClick={() => setIsOpen(true)}>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <FormItem>
                          ...
                          >
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="EPSG:2927">NAD83 Washington State Plane South (EPSG:2927)</SelectItem>
                            </SelectContent>
                          </Select>
                          <FormDescription>
                        ...
                        <div className="grid grid-cols-3 gap-3">
                          ...
                          >
                            <CardContent className="flex flex-col items-center justify-center p-4">
                              ...
                              <span className="text-xs text-muted-foreground">Current map view</span>
                            </CardContent>
                          </Card>
            ...
            {currentStep === 3 && (
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Configure the output file options.
                </p>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Choose compression for the exported files.
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <div className="p-4 bg-muted rounded-md">
                  ...
                  <div className="text-xs space-y-1">
                    <p><strong>Format:</strong> {form.watch('format').toUpperCase()}</p>
                    <p><strong>Layers:</strong> {form.watch('selectedLayers').length} selected</p>
                    <p><strong>Area:</strong> {form.watch('exportArea')} region</p>
                    <p><strong>Filename:</strong> {form.watch('filename')}.{getFileExtension(form.watch('format'))}</p>
                  </div>
                </div>
              </div>
            )}
