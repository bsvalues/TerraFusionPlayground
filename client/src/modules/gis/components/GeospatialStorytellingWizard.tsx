          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>Zoom level when the story starts (1-20)</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
            ...
            render={({ field }) => (
              <FormItem className="flex flex-row items-start space-x-3 space-y-0 mt-8">
                ...
                <div className="space-y-1 leading-none">
                  ...
                  <FormDescription>Show terrain in 3D when available</FormDescription>
                </div>
              </FormItem>
            )}
          />
    ...
    return (
      <div className="space-y-4">
        <div className="flex justify-between items-center">
          ...
          <Button type="button" variant="outline" size="sm" onClick={addStoryPoint}>
    ...
    return (
      <div className="space-y-4">
        <div className="flex justify-between items-center">
          ...
          <Button type="button" variant="outline" size="sm" onClick={addStoryPath}>
  ...
  const renderStyling = () => {
    return (
      <div className="space-y-4">
        ...
        <FormDescription>Configure how your story looks and behaves</FormDescription>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Select a primary color for your custom theme</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
