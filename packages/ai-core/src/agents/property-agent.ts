...
export class PropertyAssessmentAgent extends BaseAgent {
  ...
  protected registerCapabilities(): void {
    ...
    this.registerCapability({
      ...
      handler: async (params) => this.findComparableProperties(params.propertyId, params.radius, params.limit)
    });
    ...
    this.registerCapability({
      ...
      handler: async (params) => this.calculatePropertyValue(params.propertyId, params.useComparables)
    });
  ...
  private async findComparableProperties(
    ...
    try {
      ...
      const comparableProperties = await this.storage.find('properties', {
        type: property.type,
