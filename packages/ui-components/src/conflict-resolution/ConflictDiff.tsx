 ...
 * Render a diff item
 */
const renderDiffItem = (item: DiffItem, index: number, showVisualStatus: boolean): React.ReactNode => {
  const colorClasses = {
  ...
  return (
    ...
    >
      ...
      {item.path && (
        <span className="font-bold mr-2">{item.path}: </span>
      )}
      ...
      <div className={clsx('conflict-diff grid grid-cols-2 gap-4', className)}>
        <div className="local-changes">
          ...
          <div className={clsx(
            ...
            <pre className="text-sm font-mono">
              {formatValue(conflict.localValue, textMode)}
            </pre>
          </div>
        </div>
        ...
        <div className="remote-changes">
          ...
          <div className={clsx(
            ...
            <pre className="text-sm font-mono">
              {formatValue(conflict.remoteValue, textMode)}
            </pre>
          </div>
        </div>
      </div>
